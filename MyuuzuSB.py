...
#cl = LINETCR.LINE()
#cl.login(token="initoken")
#cl.loginResult()

ki = kk = kc = cl 

print "Success login to selfbot system"
reload(sys)
...
║ Command List
╠════════════════
║❂͜͡➣ Mayhem [Dangerous!! Use wisely!!] 
║❂͜͡➣ Ginfo 
║❂͜͡➣ Ourl 
║❂͜͡➣ Curl 
║❂͜͡➣ Speed 
...
║❂͜͡➣ Backup me
╠════════════════
║Contact me http://line.me/ti/p/~fate_harlaown
═════════════════"""
...
wait = {
    ...
    'timeline':True,
    'autoAdd':False,
    'message':"Thanks for add me to your friendlist.",
    "lang":"JP",
    "comment":"Thanks for add me to your friendlist.",
    "commentOn":False,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
